...
const bd = {
    ...
    especialidades: [
        ...
        { _id: 4, nombre: 'Pediatría', medicina: 'Medicina infantil' },
    ...
    pacientes: [
        { _id: 1, rut: '12345678', nombre: 'José González', fecha_nacimiento: '1980-05-15', direccion: 'Calle A 100', telefono: '9111111111', email: 'jose@example.com' },
        { _id: 2, rut: '23456789', nombre: 'Rosa López', fecha_nacimiento: '1990-08-22', direccion: 'Calle B 200', telefono: '9122222222', email: 'rosa@example.com' },
        { _id: 3, rut: '34567890', nombre: 'Pedro Martínez', fecha_nacimiento: '1975-03-10', direccion: 'Calle C 300', telefono: '9133333333', email: 'pedro@example.com' },
        { _id: 4, rut: '45678901', nombre: 'Carla Rodríguez', fecha_nacimiento: '1995-11-30', direccion: 'Calle D 400', telefono: '9144444444', email: 'carla@example.com' },
        { _id: 5, rut: '56789012', nombre: 'Miguel Sánchez', fecha_nacimiento: '1985-07-05', direccion: 'Calle E 500', telefono: '9155555555', email: 'miguel@example.com' }
    ],
